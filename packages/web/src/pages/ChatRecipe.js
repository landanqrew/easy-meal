...
export default function ChatRecipe() {
    ...
    return (<div style={styles.page}>
      <div className="chat-container">
        ...
        {/* Messages */}
        <div className="chat-messages">
          {messages.map((msg, i) => (<div key={i} className={`chat-bubble ${msg.role === 'user' ? 'user' : 'assistant'}`}>
              {msg.content}
            </div>))}
          ...
          {/* Recipe preview card */}
          {recipe && !loading && (<div style={styles.recipeCard}>
              ...
              <details style={styles.details}>
                ...
                <ul style={styles.ingredientList}>
                  {recipe.ingredients.map((ing, i) => (<li key={i}>
        ...
        {/* Input area */}
        {!recipe && (<div className="chat-input-area">
            <input ref={inputRef} type="text" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={handleKeyDown} placeholder="Describe what you're craving..." disabled={loading} autoFocus/>
        ...
        {recipe && (<div className="chat-input-area">
            <input ref={inputRef} type="text" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={handleKeyDown} placeholder="Ask for modifications or a different recipe..." disabled={loading}/>
            <button onClick={() => {
                setRecipe(null);
                handleSend();
