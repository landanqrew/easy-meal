...
export default function CreateGroceryList() {
    ...
    const [selectedRecipes, setSelectedRecipes] = useState(new Map());
    useEffect(() => {
    ...
    if (isPending || loading) {
        ...
        <div style={styles.card}>
          ...
          <div>
            ...
            {Array.from({ length: 4 }).map((_, i) => (<div key={i} style={{ border: `1px solid ${colors.border}`, borderRadius: '8px', padding: '1rem', marginBottom: '0.75rem' }}>
    ...
    return (<div style={styles.container}>
      <div style={styles.card}>
        ...
        <div style={styles.section}>
          ...
          <input type="text" value={listName} onChange={(e) => setListName(e.target.value)} placeholder="e.g., This week's groceries" style={styles.input}/>
        </div>
          ...
          {recipes.length === 0 ? (<div style={styles.emptyState}>
              ...
              {recipes.map((recipe) => {
                ...
                return (<div key={recipe.id} style={{
                    ...
                    {isSelected && (<div style={styles.servingsControl}>
                        <button onClick={(e) => {
                            e.stopPropagation();
        ...
        <button onClick={handleCreate} disabled={creating || selectedRecipes.size === 0} className="btn-primary" style={{ width: '100%', padding: '0.875rem', fontSize: '1rem' }}>
