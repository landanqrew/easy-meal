...
export default function ImportRecipe() {
    ...
    return (<div style={styles.container}>
      <div style={styles.card}>
        ...
        {/* Upload state */}
        {(state === 'upload' || state === 'error') && (<div style={{
                ...styles.dropZone,
            ...
            <input ref={fileInputRef} type="file" accept="application/pdf,image/jpeg,image/png" onChange={handleFileChange} style={{ display: 'none' }}/>
          </div>)}

        {/* Processing state */}
        {state === 'processing' && (<div style={styles.processingContainer}>
        ...
        {state === 'preview' && recipe && (<div>
            ...
            <section style={styles.section}>
              ...
              <ul style={styles.ingredientList}>
                {recipe.ingredients.map((ing, i) => (<li key={i} style={styles.ingredientItem}>
            ...
            <div style={styles.actions}>
              <button onClick={handleSave} className="btn-primary" style={{ padding: '0.75rem 1.5rem' }} disabled={saving}>
                {saving ? 'Saving...' : 'Save Recipe'}
              </button>
              <button onClick={handleTryAgain} className="btn-secondary" style={{ padding: '0.75rem 1.5rem' }} disabled={saving}>
                Try Again
              </button>
            </div>
          </div>)}
