    ...
    return (<div style={styles.container}>
      <nav style={styles.nav}>
        <div style={styles.navContainer}>
          ...
          {session && (<div className="home-center-links">
          ...
          <div style={styles.rightActions}>
            {session ? (<Link to="/profile" className="profile-pill">
      ...
      <main style={styles.main}>
        <div style={styles.hero}>
          <div style={styles.heroText}>
            ...
            {session ? (<div style={styles.dashboardActions}>
...
export default function App() {
    return (<BrowserRouter>
      <Routes>
        ...
        <Route path="/household" element={<ProtectedRoute>
              <Household />
            </ProtectedRoute>}/>
        <Route path="/recipes" element={<ProtectedRoute>
              <Recipes />
            </ProtectedRoute>}/>
        <Route path="/recipes/create" element={<ProtectedRoute>
              <CreateRecipe />
            </ProtectedRoute>}/>
        <Route path="/recipes/chat" element={<ProtectedRoute>
              <ChatRecipe />
            </ProtectedRoute>}/>
        <Route path="/recipes/import" element={<ProtectedRoute>
              <ImportRecipe />
            </ProtectedRoute>}/>
        <Route path="/recipes/:id" element={<ProtectedRoute>
              <RecipeDetail />
            </ProtectedRoute>}/>
        <Route path="/grocery-lists" element={<ProtectedRoute>
              <GroceryLists />
            </ProtectedRoute>}/>
        <Route path="/grocery-lists/create" element={<ProtectedRoute>
              <CreateGroceryList />
            </ProtectedRoute>}/>
        <Route path="/grocery-lists/:id" element={<ProtectedRoute>
              <GroceryListDetail />
            </ProtectedRoute>}/>
        <Route path="/recipe-lists" element={<ProtectedRoute>
              <RecipeLists />
            </ProtectedRoute>}/>
        <Route path="/recipe-lists/:id" element={<ProtectedRoute>
              <RecipeListDetail />
            </ProtectedRoute>}/>
        <Route path="/discover" element={<ProtectedRoute>
              <Discover />
            </ProtectedRoute>}/>
        <Route path="/discover/recipes/:id" element={<ProtectedRoute>
              <PublicRecipeDetail />
            </ProtectedRoute>}/>
        <Route path="/meal-plan" element={<ProtectedRoute>
              <MealPlan />
            </ProtectedRoute>}/>
      </Routes>
    </BrowserRouter>);
