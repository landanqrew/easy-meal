...
recipeListsRouter.post('/:id/recipes', async (c) => {
    ...
    const existing = await db.query.recipeListItems.findFirst({
        where: and(eq(recipeListItems.recipeListId, listId), eq(recipeListItems.recipeId, recipeId)),
    });
    if (existing) {
...
recipeListsRouter.delete('/:id/recipes/:recipeId', async (c) => {
    ...
    await db.delete(recipeListItems).where(and(eq(recipeListItems.recipeListId, listId), eq(recipeListItems.recipeId, recipeId)));
