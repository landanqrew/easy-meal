import { pgTable, uuid, varchar, text, timestamp, integer, decimal, boolean, jsonb, pgEnum, primaryKey, unique, index, } from 'drizzle-orm/pg-core';
...
// ============================================================================
export const recipeLists = pgTable('recipe_lists', {
    id: uuid('id').defaultRandom().primaryKey(),
    userId: text('user_id')
...
// ============================================================================
export const recipeListItems = pgTable('recipe_list_items', {
